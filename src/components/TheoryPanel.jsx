...
export function TheoryPanel({ phase, onOpenGallery }) {
  const phaseData = {
    ...
    3: {
      title: 'Етап 3: Накладання та Початок Відштовхування',
      subtitle: 'Суміщений стан ядер Барію-142 та Криптону-91',
      desc: 'Ядро Урану-235 складається із суміщених структур ядер Барію-142 та Криптону-91. Після влучання нейтрона ці два ядра починають зсуватися від початкового накладеного стану, а електростатичне відштовхування розпихає їх у різні боки.',
      diagramImg: '/screenshots/Uranium destruction.webp',
      strongVal: 60,
      coulombVal: 92
    },
    4: {
      title: 'Етап 4: Повний Розліт & E=mc²',
      subtitle: 'Розліт атомів Барію і Криптону та 3 жовті кульки',
      desc: 'Атоми Барію-142 та Криптону-91 повністю відокремлюються та розлітаються у протилежні боки! Одночасно випромінюються 3 вільні нейтрони (жовті кульки) та синусоїдальні хвилі гамма-випромінювання. E = mc² = 200 МеВ.',
